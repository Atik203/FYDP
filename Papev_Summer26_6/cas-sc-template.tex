...
\begin{figure}
  \centering
  \includegraphics[width=0.72\linewidth]{fig-trust-detail.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.95\linewidth]{fig-round-loop.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.98\linewidth]{fig-dataflow.png}
