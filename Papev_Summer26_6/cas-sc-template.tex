...
\begin{table}
\caption{Datasets used in the evaluation. BrokenMath and BrokenArXiv create a false majority, HLE sets the difficulty ceiling, and GPQA and MMLU-Pro measure accuracy under stable conditions.}\label{tbl:datasets}
\renewcommand{\arraystretch}{1.2}
