...
% Short title
\shorttitle{Trust-Calibrated Multi-Agent Deliberation for Mitigating Sycophantic Consensus}

% Short author
\shortauthors{Rahaman et~al.}

% Main title of the paper
\title [mode = title]{Trust-Calibrated Multi-Agent Deliberation for Mitigating Sycophantic Consensus in LLM Reasoning} 


\author[1]{Md. Atikur Rahaman}%[style=chinese]
[%
   type=editor,
        auid=000,bioid=1,
                        prefix=,
                        role=, 
                        orcid=0000-0002-8776-7145,]
\cormark[1]
...
\begin{table}
\caption{Pipeline stages and model calls for one debated question.}\label{tbl:rounds}
\begin{tabular*}{\textwidth}{@{\extracolsep\fill}ll}
\toprule
\textbf{Stage} & \textbf{Model calls}\\
\midrule
...
\begin{figure}
  \centering
  \includegraphics[width=0.98\linewidth]{data-flow.png}
