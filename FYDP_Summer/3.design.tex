...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{fig-context.png}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{fig-dataflow.png}
...
\begin{center}
  \begin{table}[ht]
    ...
    \begin{tabular}{|p{0.26\textwidth}|p{0.18\textwidth}|p{0.42\textwidth}|}
      ...
      Gate              & Due            & Checkpoint                                                                                              \\
      \hline
      Gate 0            & End of Month 1 & Vanilla MAD reproduces the Du et al. baseline on a GPQA~\cite{rein2024gpqa} slice, and the reference list is frozen         \\
      \hline
...
Phase-0 spans weeks 1 through week 4. Weeks 1 and 2 are focused on freezing literature and locking reference lists, with each paper being evaluated against their respective DOIs. Weeks 3 setup vLLM and LangGraph. Week 4 evaluates all three models on a small GPQA~\cite{rein2024gpqa} slice. We need to reproduce Du et al. results on that same slice with our vanilla MAD baseline before moving forward with Phase-1.
