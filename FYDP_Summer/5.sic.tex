...
Table~\ref{tab:po_map} lists the six program outcomes that FYDP I covers.

\begin{center}
    \begin{table}[ht]
        \centering
        \caption{Program outcomes covered by FYDP I.}
        \renewcommand{\arraystretch}{1.6}
        \begin{tabular}{|p{0.155\textwidth}|p{0.155\textwidth}|p{0.155\textwidth}|p{0.155\textwidth}|p{0.155\textwidth}|p{0.155\textwidth}|}
            \hline
            PO1                   & PO2              & PO4           & PO10          & PO11                          & PO12               \\
            Engineering knowledge & Problem analysis & Investigation & Communication & Project management and finance & Life-long learning  \\
            \hline
        \end{tabular}
        \label{tab:po_map}
    \end{table}
