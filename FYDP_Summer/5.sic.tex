...
\paragraph{K1: Natural sciences} K1 has been addressed. The framework answers scientific questions and checks each claim against papers from PubMed, arXiv, Semantic Scholar, and OpenAlex. The evaluation datasets include natural science questions. The project does not derive new natural science theory. The problem domain and the evidence base still come from natural science fields. That is why K1 is marked as covered.
...
Six program outcomes are covered by FYDP I. PO1 is covered by the real-life problem in Chapter 1. PO4 is covered by the literature review and the gap analysis in Chapter 2. PO2 is covered by the requirements work in Chapter 3. PO10 is covered by the interim report and the oral presentation. PO11 is covered by the timeline and the budget. PO12 is covered by the journal writing and the independent learning record. The other six program outcomes are handled in FYDP II and FYDP III.
